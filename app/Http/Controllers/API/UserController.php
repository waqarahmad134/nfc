...
class UserController extends Controller
{
    ...
    public function show(ShowUserRequest $request)
    {
        ...
        $pass_data = [
            ...
            "web_url" => "https://banknfc.saudi360inc.com/?Uid=".$request->id,
    ...
    // TODO: please remove the below code after applying dynamic content. below just for sample array data
    //$pass_data = [
    //'user_id' => '1',
    //'name' => 'Noman Javaid',
    //'designation' => 'Flutter Developer',
    //'organization_name' => 'Saudi 360 Inc',
    //'description' => 'Digital Marketing Company',
    //'web_url' => 'https://nfc.saudi360inc.com/nfcmulti.html?Cid=VJief6WTsuekShPwB8yJ69XDEEm1&Docid=aep8Ojq1tpdELG4TtqQZ&Uid=2987',
    //];
}
