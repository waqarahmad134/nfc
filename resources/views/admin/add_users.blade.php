                        ...
                        <div class="px-5">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <input name="first_name" type="text" class="form-control" placeholder="Enter First Name Here" required>
                                </div>
                                <div class="col-md-6 col-lg-6">
                                    <label>Last Name</label>
                                    <input name="last_name" type="text" class="form-control" placeholder="Enter Last name here" required>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-6 col-lg-6">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <label>Role</label>
                                    <input name="role" type="text" class="form-control" value="employee" readonly>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-6 col-lg-6">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                        <input name="employee_level" value="default" id="default" type="radio" checked>
                                        <label for="default">Default</label>
                                    </div>
                                    <div class="col-md-4 col-lg-4">
                                        <input name="employee_level" value="management" id="management" type="radio">
                                        <label for="managment">Management</label>
                                    </div>
                                    <div class="col-md-4 col-lg-4">
                                        <input name="employee_level" value="staff" id="staff" type="radio">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <input name="telephone_number" type="text" class="form-control" placeholder="Telephone Number ">
                                </div>
                                <div class="col-md-6 col-lg-6">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <input name="insta_url" type="text" class="form-control">
                                </div>
                                <div class="col-md-6 col-lg-6">
                                    <label>Snapchat URL</label>
                                    <input name="snapchat_url" type="text" class="form-control">
                                </div>
                                <div class="col-md-6 col-lg-6">
                            ...
                            <input type="submit" href="#" class="btn mt-3 mb-3 float-right" style="background-color: #002E63; color: white;" value="Add User" />
                        </div>
                    </form>
                </div>
            </div>
...
$('#addproduct').on('submit', (function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: "https://360nfc.saudi360inc.com/public/api/user/store",
            data: formData,
            headers: headers,
            cache: false,
            contentType: false,
