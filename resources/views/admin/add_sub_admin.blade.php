                    ...
                    <form method="POST"  id="addproduct" enctype="multipart/form-data">
                        ...
                        <div class="px-5">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <label>Role</label>
                                    <input name="role" type="text" class="form-control" value="subadmin" readonly>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-6 col-lg-6">
                             ...
                             <div class="row mt-3">
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                        <input name="employee_level" value="default" id="default" type="radio"  >
                            ...
                            <input type="submit" href="#" class="btn mt-3 mb-3 float-right" style="background-color: #002E63; color: white;" value="Add Sub Admin" />
                        </div>
                    </form>
                </div>
            </div>
