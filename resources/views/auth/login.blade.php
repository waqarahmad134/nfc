                ...
                <div class="col-12">
                    <nav class="navbar navbar-expand-lg">
                        <a class="navbar-brand" href="javascript:void(0);">
                            <img src="{{asset('public/assets/images/logo.webp')}}" class="d-inline-block align-top mr-2 img-fluid" alt="logo" width="200">
                        </a>
                    </nav>
                </div>
                <div class="col-lg-8">
                    ...
                    <div class="card" style="background-color: lightgrey; border-color: lightgrey;">
                        ...
                        <div class="body">
                            <form method="POST" class="form-auth-small" action="{{route('logins')}}">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg btn-block" style="background-color: #00072D; border-color: #00072D;">LOGIN</button>
    ...
    <script>
        function forgot_password() {
            ...
            if (email === '') {
                ...
                $.ajax({
                    url: "https://banknfc.saudi360inc.com/public/api/forgot-password",
                    type: "post",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "email": email,
