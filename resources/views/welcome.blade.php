...
<body class="theme-orange">
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30">
                <img class="img-fluid rounded" src="{{asset('public/assets/images/logo-dark.webp')}}" alt="Bank NFC Logo" class="img-fluid" width="200_skins">
            </div>
            <p>Please wait...</p>
        </div>
    </div>
            ...
            <div class="container-fluid">
                <div class="navbar-left">
                    <div class="navbar-btn">
                        <a href="{{route('home')}}"><img src="{{asset('public/assets/images/logo.webp')}}" alt="Bank NFC Logo" class="img-fluid logo"></a>
            ...
            <div class="sidebar-scroll">
                <div class="user-account">
                    <div class="" style="cursor:pointer;">
                        <img class="img-fluid" src="{{asset('public/assets/images/logo-dark.webp')}}" alt="Logo Bank NFC">
                    </div>
                </div>
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu">
                        ...
                        <li class="@if(\Request::route()->getName() == 'editUser') active  @endif">
                            <a href="{{ route('editUser',['id' => session()->get("user_data")->id]) }}"><i class="fa fa-edit"></i><span>Update Profile</span></a>
                        </li>
                        <li>
