...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="https://360nfc.saudi360inc.com/nfcmulti.css"
    />
  ...
  <body style="background:#00072D;">
    <div class="preloader">
        <div id="preloader_img" class="h-100 d-flex justify-content-center align-items-center">
            <img class="img-fluid" src="https://nfc.saudi360inc.com/preloader.gif" alt="preloader" width="300" />
        </div>
    </div>
            ...
            <div class="card">
              <div class="card-banner">
                ...
                >
                  <img
                    class="rounded"
                    src="https://banknfc.saudi360inc.com/qrcode.webp"
                    width="30"
                  />
                </a>
                <a
              ...
              <div class="middle my-2">
                ...
                <a class="btn twitter" id="twitter" href="#">
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function () {
        fetch(
          `https://360nfc.saudi360inc.com/public/api/user/show?id=${UserID}`
        )
