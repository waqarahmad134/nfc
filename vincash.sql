...
(1, 'admin', 'Khan', 'vikitech', 'ghh', 'utah', '55150', '+92.03472299343', 'admin@gmail.com', 'admin', 1, NULL, '$2b$10$h0X/apWcDo.GdygS6jcWR.Yx8SwTdjQna1kHbfJzDNFGXjvXdn4Km', NULL, '2022-05-13 11:07:49', '2023-06-15 05:05:52', 'fnmmaOtRv8JfFnLiDsLJA3:APA91bGFWhNJd-eoGbwH1UtZhvqP2lKvgn9sUk6PwSz_0-v-v8Rzlil5WLbnBSfaSZe3Ju46_mytBrDaUmwXdaQdmfygJYSYQu-jBoTCKipmd_IYWyNVjROJfR-MtDZzehjlvd30U7bh'),
(6, 'Taimooor', 'Sabir', 'vikitech', 'ghh', 'utah', '55150', '+92.03472299343', 'dealer@gmail.com', 'dealer', 0, NULL, '$2y$10$iFZMPXATxWY9mRmNpUzLYeNIZX/sWlbZFtzGLFtdiOmV28NsdsbJ.', NULL, '2022-05-17 10:14:55', '2022-07-28 18:44:03', NULL),
(7, 'Nadeem', 'Khani', 'vikitech', 'ghh', 'utah', '55150', '+92.034722993433', 'sigidevelopers@gmail.com', 'dealer', 0, NULL, '$2y$10$LiPQNB9oV5.mCM/ZbXX7BObLDx6h45Jnpf9SLjf3T2CWvC34kReMi', NULL, '2022-05-17 10:17:45', '2022-07-27 19:11:10', NULL),
...
CREATE TABLE `vehicles` (
  ...
  `postal_code` varchar(255) DEFAULT NULL,
  `est_price` varchar(255) DEFAULT NULL,
  `demand_price` varchar(255) DEFAULT NULL,
  `replacing` varchar(255) DEFAULT NULL,
  `vec_exterior_color` varchar(255) DEFAULT NULL,
  `pay_off_bank` varchar(255) DEFAULT NULL,
  `lease_company` varchar(255) DEFAULT NULL,
  `repair_cost` varchar(255) DEFAULT NULL,
  `damage_history` varchar(255) DEFAULT NULL,
...
(131, '1FMCU0D72CKA11286', 'car', 'FORD', 'ESCAPE', '2012', 'XLS', '134987 KM', 'N3V 1E3', NULL, NULL, 'no', 'BLUE', NULL, NULL, '500.00', 'Minor Damage', NULL, 1, 0, '2022-07-31 21:30:14', '2022-08-04 20:16:50'),
...
(148, '5UXKR2C58FOH36423', 'car', 'BMW', 'X5', '2015', 'tan', '98400', '76710', NULL, NULL, 'no', 'white', NULL, NULL, '1000', 'No Previous Accidents', NULL, 1, 0, '2022-11-17 08:39:28', '2022-11-17 08:39:28'),
